...
trio_plots(mtec_no_un, geneset = c("Aire", "Ccl21a", "Trpm5"),
...
trio_plots(mtec_no_un, geneset = c("GFP", "Ackr4", "Krt10"),
  cell_cycle = FALSE, plot_violin = TRUE, jitter_and_violin = FALSE,
  plot_jitter = FALSE, color = stage_color, sep_by = "cluster",
...
# Figure 5e
# Violin plots of genes of interest
trio_plots(no_at_mtec, geneset = c("Hmgb2", "Tubb5", "Stmn1"), cell_cycle = FALSE,
...
tSNE_PCA(mtecCombined, "Pou2f3", save_plot = paste0(save_dir, "/figure_s4aXIII.pdf"))
